...
<body>
<form class="form-inline definewidth m20" action="backBook" method="post" onsubmit="return check();">
     <font color="#777777"><strong>借阅号：</strong></font>
    <input id="readerId" autocomplete="off" type="number" name="lend.readerId" class="abc input-default" placeholder="数字ID" value="${lend.readerId}" >&nbsp;&nbsp;
    <font color="#777777"><strong>ISBN：</strong></font>
    <input id="isbn" autocomplete="off" type="text" name="lend.ISBN" class="abc input-default" placeholder="978-7-121-25457-4" value="${lend.ISBN}">
    <font color="#777777"><strong>数量：</strong></font>
    <input id="number" autocomplete="off" type="number" name="lend.num" class="abc input-default" placeholder="数字" value="${lend.num}">&nbsp;&nbsp;
    <button type="submit" class="btn btn-primary">还书</button><span id="msg" class="msg"></span>
</form>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
      ...
      <s:if test="#map['back']!=null">
      	<table class="table table-bordered table-hover definewidth m10">
      		<caption><h2>归还结果</h2></caption>
      		<thead>
    			<tr>
        			<th>ISBN</th>
       				<th>借阅号</th>
