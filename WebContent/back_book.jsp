...
<body>
<form class="form-inline definewidth m20" action="backBook" method="post">
     <font color="#777777"><strong>借阅号：</strong></font>
    <input autocomplete="off" type="number" name="lend.readerId" class="abc input-default" placeholder="数字ID" value="${lend.readerId}" >&nbsp;&nbsp;
    <font color="#777777"><strong>ISBN：</strong></font>
    <input autocomplete="off" type="text" name="lend.ISBN" class="abc input-default" placeholder="978-7-121-25457-4" value="${lend.ISBN}">
    <font color="#777777"><strong>数量：</strong></font>
    <input autocomplete="off" type="number" name="lend.num" class="abc input-default" placeholder="数字" value="${lend.num}">&nbsp;&nbsp;
    <button type="submit" class="btn btn-primary">还书</button><span class="msg"></span>
</form>
